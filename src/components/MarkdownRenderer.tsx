...
const MarkdownRenderer = ({content, className}:{content:string;className:string}) => {
  ...
  children={content}
    ...
    components={{
      ...
      code: ({node, ...props}) => <div className='mt-10 mb-5'><CodeBlock className="bg-blue-950/50 m-10" theme={tomorrowNightBlue} {...props} text={props.children} language="javascript"/></div>,
